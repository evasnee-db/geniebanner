...
function SearchAskBuildShellInner() {
  const searchParams = useSearchParams()
  const searchUrlQuery = searchParams.get("search") ?? ""
  return <ShellHomeView experienceMode="searchAskBuild" searchUrlQuery={searchUrlQuery} />
}

export default function SearchAskBuildShellPage() {
  return (
    <AppShell
      activeItem=""
